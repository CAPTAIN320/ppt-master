...
| Project management | `project_manager.py`, `error_helper.py`, `pptx_template_import.py`, `template_fill_pptx.py`, `native_enhance_pptx.py` | [docs/project.md](./docs/project.md) |
...
| Image tools | `image_gen.py`, `latex_render.py`, `analyze_images.py` | [docs/image.md](./docs/image.md) |
